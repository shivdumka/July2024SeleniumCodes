...
//------------------------------------------------------------***ACTIONS CLASS UTILS***--------------------------------------------------
			...
			*/
			...
			public WebElement explicitWaitVisiblityOfElement(long waitingTime,By locator)
			{
				WebDriverWait wait=new WebDriverWait(driver,Duration.ofSeconds(waitingTime));
			...
			public List<WebElement> WaitForElementsVisisbility(By locator,long waitingTime)
			{
				WebDriverWait wait=new WebDriverWait(driver,Duration.ofSeconds(waitingTime));
			...
			public  void getTitleContains(String title,long waitingTime)
			{
			...
			public void getURLContains(String fractionalURL,long waitingTime)
			{
